...
from my_env import rabbitmq_host, rbq_producer_pass, rbq_producer_login, rbq_queue_for_sender, server_port
import zbx_sender
...
def process_message(queue_name, message_body):
    ...
    executor.submit(zbx_sender.prepare_data_to_zabbix, message)
...
if __name__ == "__main__":
    start_threads(rbq_queue_for_sender)
